...
class EmployeeServiceTest {
    ...
    void getEmployeeById() {
        final Employee employeeToSave = new Employee(null, "Vany", "Vany@gmail.com", 600, true, null);
        employeeService.saveEmployee(employeeToSave);
    ...
    void getEmployeeByEmail() {
        final Employee employeeToSave = new Employee(null, "Fedy", "Fedy@gmail.com", 600, true, null);
        employeeService.saveEmployee(employeeToSave);
    ...
    void getEmployeeByUsername() {
        final Employee employeeToSave = new Employee(null, "Kate", "Kate@gmail.com", 600, true, null);
        employeeService.saveEmployee(employeeToSave);
    ...
    @Test
    void getAll() {
        Employee employee6 = new Employee(null, "Gena", "Gena@gmail.com", 700, true,  null);
        Employee employee7 = new Employee(null, "Pety", "Pety@gmail.com", 900, true,  null);
        Employee employee8 = new Employee(null, "Alex", "Alex@gmail.com", 500, false, null);
    ...
    void getAllByMarried() {
        Employee employee3 = new Employee(null, "Zina", "Zina@gmail.com", 400, true, null);
        Employee employee4 = new Employee(null, "Yana", "Yana@gmail.com", 800, false, null);
    ...
    void getAllBySalaryAfter() {
        Employee employee3 = new Employee(null, "Vlad", "Vlad@gmail.com", 1000, true, null);
        Employee employee4 = new Employee(null, "Juke", "Juke@gmail.com", 300, false, null);
    ...
    void getAllBySalaryBefore() {
        Employee employee3 = new Employee(null, "Valy", "Valy@gmail.com", 1000, true, null);
        Employee employee4 = new Employee(null, "Galy", "Galy@gmail.com", 300, false, null);
    ...
    void getAllBySalaryBetween() {
        Employee employee3 = new Employee(null, "Saul", "Saul@gmail.com", 1000, true, null);
        Employee employee4 = new Employee(null, "Paul", "Paul@gmail.com", 900, false, null);
    ...
    void getAllByDepartment() {
        ...
        Employee employee1 = new Employee(null, "EQA1", "EQA1@gmail.com", 500, true,  qa);
        Employee employee2 = new Employee(null, "EQA2", "EQA2@gmail.com", 400, false, qa);
        Employee employee3 = new Employee(null, "EBA1", "EBA1@gmail.com", 400, false, ba);
    ...
    void updateEmployeeData() {
        Employee employeeToSave = new Employee(null, "UPE1", "UPE1@gmail.com", 500, false,  null);
        employeeService.saveEmployee(employeeToSave);
        Employee savedEmployee = employeeService.getEmployeeByEmail("UPE1@gmail.com");

        Employee employeeToUpdate= new Employee(savedEmployee.getId(), "UPE2", "UPE2@gmail.com", 700, true,  null);
    ...
    void checkEmail() throws UsernameNotFoundException {
        Employee employeeToSave = new Employee(null, "CHECK", "CHECK@gmail.com", 500, false,  null);
        employeeService.saveEmployee(employeeToSave);
    ...
    @Test
    void deleteEmployee() {
        Employee employeeToSave = new Employee(null, "DEL1", "DEL1@gmail.com", 500, false,  null);
        employeeService.saveEmployee(employeeToSave);

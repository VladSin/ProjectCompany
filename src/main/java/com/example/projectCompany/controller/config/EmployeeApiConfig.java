...
public class EmployeeApiConfig {
    ...
    private static final String SERVER_URL = "https://project-company.herokuapp.com/employee";
    // private static final String SERVER_URL = "http://localhost:8080/employee";
